...
TH2D* h_BBgr_clus_adc_ps_notrackmatch = new TH2D("h_BBgr_clus_adc_ps_notrackmatch","; preshower e ; cluster ToT sum", 200,0,3, 200,0,200);
 ...
 TH2D  *h_BBgr_hit_time_elemID_pscut = new TH2D("h_BBgr_hit_time_elemID_pscut", "LE vs PMT for each PMT; PMT number; LE - hodo_tmean", 510,0,510, 60,-30,30 );
  ...
  //double gr_tot_cuts[10] = {15,20,25,30,35,40,45,50,55,60};
  ...
  for (int gr_cnt = 0 ; gr_cnt <nBins_gr_size ;gr_cnt++){ // row
    ...
    legend->AddEntry(h_BBps_grcut,"gr clus size >=3 && track-matched","l");
    legend->AddEntry(h_BBps_granticut,"gr clus size <=2 && track-matched","l");
    legend->AddEntry(h_BBps_nogrtrack,"no track match","l");
    legend->Draw();
 ...
 //Add a legend
    ...
    legend2->AddEntry( h_BBgr_clus_size_pscut,"ps.e > 0.2 && gr track matched","l");
    legend2->AddEntry( h_BBgr_clus_size_pscut_notrackmatch,"ps.e > 0.2 && not gr track matched","l");
    legend2->Draw();
...
//Add a legend
    ...
    legend3->AddEntry( h_BBgr_clus_size_psanticut,"ps.e <= 0.2 && gr track matched","l");
    legend3->AddEntry( h_BBgr_clus_size_psanticut_notrackmatch,"ps.e <= 0.2 && not gr track matched","l");
    legend3->Draw();
    ...
    legend4->AddEntry( h_BBgr_clus_size_pscut,"ps.e > 0.2 && gr track matched","l");
    legend4->AddEntry( h_BBgr_clus_size_psanticut,"ps.e <= 0.2 && gr track matched","l");
    legend4->Draw();
    ...
    legend5->AddEntry( h_BBgr_clus_size_pscut_notrackmatch,"ps.e > 0.2 && Not gr track matched","l");
    legend5->AddEntry( h_BBgr_clus_size_psanticut_notrackmatch,"ps.e <= 0.2 && Not gr track matched","l");
    legend5->Draw();
    ...
    legend6->AddEntry(h_BBps_grcut_totsum,"gr clus tot >= 20&& track-matched","l");
    legend6->AddEntry(h_BBps_granticut_totsum,"gr clus tot <20 && track-matched","l");
    legend6->AddEntry(h_BBps_nogrtrack,"no track match","l");
    legend6->Draw();
