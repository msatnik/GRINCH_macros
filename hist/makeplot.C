void makeplot(int run)
{
  ...
  TFile *_file0 = TFile::Open(Form("grinch_%d_grinch_hist.root",run));
 ...
 TCanvas * cADC_SHcut =  new TCanvas;
  cADC_SHcut -> SetCanvasSize(1300,1050);
  cADC_SHcut -> SetWindowSize(1350,1100);
  ...
  TCanvas *cMisc =  new TCanvas;
  cMisc -> SetCanvasSize(1300,1050);
  cMisc -> SetWindowSize(1350,1100);
  cMisc -> Divide(2,2);
