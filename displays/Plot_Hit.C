...
void Plot_Hit(){
  ...
  //for( Int_t i=0; i<nkine; i++ ){
    ...
    TFile *f1 = TFile::Open("../output/sbs8_aug30.root");
    TH1D *h1= (TH1D*)f1->Get("h_BBps_sh_e");
    ...
    TFile *f2 = TFile::Open("../output/sbs9_aug30.root");
    TH1D *h2 = (TH1D*)f2->Get("h_BBps_sh_e");
    ...
    c1->cd(2);
     ...
     legend2->AddEntry(h1_norm,"SBS8","l");
     legend2->AddEntry(h2_norm,"SBS9","l");
     legend2->Draw();
