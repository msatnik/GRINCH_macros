...
void Plot_Size_tr(){
  ...
  //for( Int_t i=0; i<nkine; i++ ){
    ...
    TFile *f2 = TFile::Open("../output/sbs8_nov24_electron.root");
    TH1D *h2 = (TH1D*)f2->Get("h_BBgr_allclus_size");
    ...
    legend->AddEntry(h1,"Track-Matched","l");
    legend->AddEntry(h3,"Not Track-Matched","l");
    ...
    h2_norm->Draw("hist");
     ...
     legend2->AddEntry(h1_norm,"Track-Matched","l");
     legend2->AddEntry(h2_norm,"Total","l");
     legend2->Draw();
