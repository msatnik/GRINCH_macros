...
void fit_p_th(){ 
  ...
  TFile *f1 = TFile::Open("../output/sbs8_oct9.root"); // Load rootfile
  TFile *f2 = TFile::Open("../output/sbs9_oct9.root"); // Load rootfile

  // Set Up Canvas

  // Load Histograms
  TH2D* hist1 = (TH2D*)f1->Get("h_BBtr_p_th_cut_mirror2");
  TH2D* hist2 = (TH2D*)f2->Get("h_BBtr_p_th_cut_mirror2");
