...
void grW2fitter_v2(){ //MAIN
  ...
  double maxBinValueCut =  h_W2_gr_cut -> GetBinContent(maxBinCut);
  double maxBinXValueCut =  h_W2_gr_cut->GetXaxis()->GetBinCenter(maxBinCut);
  cout<<"maxBinCut: "<<maxBinCut<<endl;
  cout<<"maxBinValueCut: "<<maxBinValueCut<<endl;
  cout<<"maxBinXValueCut: "<<maxBinXValueCut<<endl;

  //// Get max bin
  double maxBinAnticut = h_W2_gr_anticut -> GetMaximumBin();
  double maxBinValueAnticut =  h_W2_gr_anticut -> GetBinContent(maxBinAnticut);
  double maxBinXValueAnticut =  h_W2_gr_anticut->GetXaxis()->GetBinCenter(maxBinAnticut);
  cout<<"maxBinAnticut: "<<maxBinAnticut<<endl;
